...
export default function TerminalAbout() {
  ...
  const handleCommand = (cmd: string) => {
    ...
    if (cleanCmd === "cd /education" || cleanCmd === "cd education") setSection("education");
    else if (cleanCmd === "cd /experience" || cleanCmd === "cd experience") setSection("experience");
    else if (cleanCmd === "cd /about" || cleanCmd === "cd about") setSection("about");
    else if (cleanCmd === "cd /skills" || cleanCmd === "cd skills") setSection("skills");
